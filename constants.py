...
kOptions = [kRaceOptions, kInsuranceOptions, kPoliticalOptions, kCovidInfoSourceOptions, kMaskFrequencyOptions, kReasonOptions]

kColNames = ['Age', 'Condition', 'Education', 'Housing', 'Insurance', 'Gender', 'Has_Doctor'] + [option for option_type in kOptions for option in option_type]
...
kOrderingDict = {
    ...
    'Race' : ['African American / Black', 'Asian', 'Hispanic or Latinx',
              'Middle Eastern', 'Native American', 'Native Hawaiian / Pacific Islander',
              'White Non-Latinx', 'Other', 'Multiracial', 'Missing'],
    'Prior Condition' : ['Yes', 'No', 'Missing'],
    'Political Affiliation' : ['Democrat', 'Independent', 'Republican', 'Other', 'No Affiliation', 'Multiparty', 'Missing'],
    'Has Primary Care Physician' : ['Yes', 'No', 'Missing'],
    'Education' : ['High School or Less', 'Some College', 'College Degree', 'Graduate or Professional Degree', 'Missing'],
